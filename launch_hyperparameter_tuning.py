...
def launch_control(baseconfig_filename='hyperparam_model.cfg',submit_runs=False, hyperparam_adjustments=[{}]):
...
cd $root_dir
python -u hyperparameter_tuner.py {config_filename}
...
if __name__=='__main__':
    ...
    launch_control(baseconfig_filename='hyperparam_model.cfg',submit_runs=True,hyperparam_adjustments=hyperparam_adjustments)
